...
Flops_baselines = {
    ...
    "googlenet": {
        "uadfv": 1500.0,  # Example value; adjust as needed
    }
}
...
class TrainDDP:
    def __init__(self, args):
        ...
        self.compress_rate = args.compress_rate  # Added from second code
    ...
    def define_loss(self):
        ...
        self.mask_loss = loss.MaskLoss().cuda()  # Using the same as both codes
